...
import Map from '../../../assets/maps/13-willow-street.svg';
...
const PINS = {
  ...
  BBCORNER: 'BOYS BEDROOM CORNER',
  MBCORNER: 'MASTER BEDROOM CORNER',
  GARAGE1: 'GARAGE 1',
  GARAGE2: 'GARAGE 2',
  GARAGE3: 'GARAGE 3',
  BASEMENT: 'BASEMENT',
    ...
    <GestureDetector gesture={composed}>
      <Animated.View style={animatedStyles}>
        <View style={[styles.container]}>
          ...
          <TouchableOpacity
            style={[styles.pin, {top: '23%', left: '89%'}]}
            onPress={() => handlePinPress(PINS.BBCORNER)}>
            <Pin
              width={15}
              height={15}
              fill={
                selectedPins.includes(PINS.BBCORNER) ? '#ff3333' : '#4BB543'
              }
            />
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.pin, {top: '23%', left: '61%'}]}
            onPress={() => handlePinPress(PINS.MBCORNER)}>
            <Pin
              width={15}
              height={15}
              fill={
                selectedPins.includes(PINS.MBCORNER) ? '#ff3333' : '#4BB543'
              }
            />
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.pin, {top: '70%', left: '37.5%'}]}
          ...
          <TouchableOpacity
            style={[styles.pin, {top: '61%', left: '37.5%'}]}
          ...
          <TouchableOpacity
            style={[styles.pin, {top: '54%', left: '37.5%'}]}
            onPress={() => handlePinPress(PINS.GARAGE3)}>
            <Pin
              width={15}
              height={15}
              fill={selectedPins.includes(PINS.GARAGE3) ? '#ff3333' : '#4BB543'}
            />
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.pin, {top: '62%', left: '26%'}]}
...
export default WillowStreetMap;
